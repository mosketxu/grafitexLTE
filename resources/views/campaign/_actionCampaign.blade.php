<div class="text-right">
        ...
        @endif
        &nbsp; &nbsp;&nbsp;
        <a href="{{route('campaign.filtrar', $id) }}" title="Filtrar"><i class="fas fa-filter text-teal fa-2x mx-1"></i></a>
        <a href="{{route('campaign.elementos', $id ) }}" title="Elementos"><i class="fab fa-elementor text-navy fa-2x mr-1"></i></a>
