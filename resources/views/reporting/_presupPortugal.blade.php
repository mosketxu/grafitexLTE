   ...
   <table width="100%" style="margin:0 auto" cellspacing="0">
      <thead>
         ...
         <tr>
            ...
            <th width="25.5%" style="text-align: right;padding-right:10px;border:1px solid;background-color: #03a9f4"><span style="font-size: medium">{{number_format($picking->picking + $picking->transporte + $totalExtras +$totalMaterialesPt,2,',','.')}} <span style="font-family: sans-serif;">€</span></span></th>
         </tr>
      </thead>
   </table>
</div>
