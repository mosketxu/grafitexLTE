                     ...
                     <div class="row">
                        <div class="form-group col">
                           ...
                           <input type="text" class="form-control-sm form-control" id="referencia"
                              name="referencia" value="{{$campaignpresupuesto->referencia}}" readonly>
                        </div>
                        <div class="form-group col-1">
                           <label class="form-label-sm" for="version">Versión</label>
                           <input type="number" class="form-control-sm form-control" id="version"
                              name="version" step="0.1" value="{{$campaignpresupuesto->version}}" readonly>
                        </div>
                        <div class="form-group col">
                        ...
                        <div class="form-group col">
                           ...
                           <input type="text" class="form-control-sm form-control" id="atencion"
                              name="atencion" value="{{$campaignpresupuesto->atencion}}" readonly>
                        </div>
                        <div class="form-group col">
                           ...
                           <div class="card-body">
                              <div class="form-group">
                                 <div class="table-responsive" style="height:300px">
                                    <table id="tMaterial" class="table table-hover table-sm small sortable" cellspacing="0" width=100%>
                                       <thead>
                                          <tr>
                                       ...
                                       <tfoot>
                                          <tr>
                                             ...
                                             <th class="text-center" >Observaciones</th>
                                             <th class="text-center" width="140px"></th>
                                          </tr>
                                       </tfoot>
                                    </table>
