                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route('campaign.index')}}" class="nav-link active">
                                <i class="far fa-circle nav-icon"></i><p>Listado Campañas</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="" class="nav-link">
                                <i class="far fa-circle nav-icon"></i><p>Nueva campaña simple</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="" class="nav-link">
                                <i class="far fa-circle nav-icon"></i><p>Nueva campaña masiva</p>
                            </a>
                        </li>
                    </ul>
                </li>
